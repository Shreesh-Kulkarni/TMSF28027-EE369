...
void InitEPwm2Example()
{
    ...
    // Setup TBCLK
    PWM_setCounterMode(myPwm2, PWM_CounterMode_Down);     // Count down
    ...
    PWM_setActionQual_CntDown_CmpA_PwmA(myPwm2, PWM_ActionQual_Clear);  // Set PWM2A on event A, up count

    PWM_setActionQual_Period_PwmB(myPwm2, PWM_ActionQual_Clear);    // Clear PWM2B on Period
    PWM_setActionQual_CntDown_CmpB_PwmB(myPwm2, PWM_ActionQual_Clear);  // Set PWM2B on event B, up count
...
void InitEPwm3Example(void)
{
    ...
    // Setup TBCLK
    PWM_setCounterMode(myPwm3, PWM_CounterMode_UpDown);     // Count updown
